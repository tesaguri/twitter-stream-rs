#![doc(html_root_url = "https://docs.rs/twitter-stream/0.11.0")]
...
[`timeout` example]: https://github.com/tesaguri/twitter-stream-rs/blob/v0.11.0/examples/timeout.rs
...
[`echo_bot` example]: https://github.com/tesaguri/twitter-stream-rs/blob/v0.11.0/examples/echo_bot.rs
